...
class PlaylistPageMoods extends StatefulWidget {
  const PlaylistPageMoods({super.key, required this.firstIndex, required this.playlistmood});
  final int firstIndex;
  final String playlistmood;

  @override
  State<PlaylistPageMoods> createState() => _PlaylistPageState();
}

class _PlaylistPageState extends State<PlaylistPageMoods> {
