...
child: Column( 
children: [
Padding( padding:  EdgeInsets.only(left: sizeQuery.height/40),
 child: Padding( padding:  EdgeInsets.only(bottom: sizeQuery.height/20, ),
...
child: Container( height: sizeQuery.height/2.6,
...
child: Container( height: sizeQuery.height/2.75,
decoration: BoxDecoration(
color: Colors.black, borderRadius: BorderRadius.circular(20)
 ),
child: Column( 
