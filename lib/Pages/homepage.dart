...
final sizeQuery = MediaQuery.of(context).size;
   List<String> selectedMood = selectedMoods.entries.where((entry) => entry.value == true).map((entry) => entry.key).toList();
...
SizedBox(height: sizeQuery.height / 40),
 Padding( padding:  EdgeInsets.only(left: sizeQuery.width/45),
...
return SizedBox( height: sizeQuery.height / 3.65,
...
Padding(
padding:  EdgeInsets.only(right: sizeQuery.width/3),
child: Column( crossAxisAlignment: CrossAxisAlignment.start,
children: [
